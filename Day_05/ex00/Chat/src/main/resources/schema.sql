...
VALUES (1, 2, 'About turn! March!', TO_TIMESTAMP('2030-010-21 13:32:24', 'YYYY-MM-DD HH:MI:SS'));
INSERT INTO message (author, room, text, date)
...
INSERT INTO message (author, room, text, date)
VALUES (4, 1, 'Comrade mauser, you have the floor.', TO_TIMESTAMP('2024-01-1 13:30:20', 'YYYY-MM-DD HH:MI:SS'));
INSERT INTO message (author, room, text, date)
